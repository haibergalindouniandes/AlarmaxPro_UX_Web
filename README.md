...
## Control de cambios
Aunque en la maquetación Web se intentó de ser lo más fiel a los Mockups diseñados con la herramienta Adobe XD, dado a diversos temas asociados al conocimiento, decisiones de diseño y restricciones en los diferentes lenguajes utilizados para dicha maquetación, se evidencian algunas diferencias entre los dos diseños. Las diferencias más representativas son listadas y justificadas en el siguiente Excel como un control de cambios.
